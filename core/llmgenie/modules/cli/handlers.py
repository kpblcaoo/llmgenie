...
from core.llmgenie.generators.json_generator import get_folder_structure
from core.llmgenie.self_run import attach_to_llm_request
from core.llmgenie.modules.cli.utils import load_gitignore, read_file_content, write_to_file
from core.llmgenie.modules.cli.handlers_legacy import interactive_legacy
...
async def interactive_modular(args):
    ...
    from core.llmgenie.cli_core import create_cli_core
