...
from core.llmgenie.modules.cli.utils import load_config
from core.llmgenie.generators.json_generator import generate_json
...
def parse(args):
    ...
    if not goals:
        logging.warning(
            "No project goals specified via --goals or core.llmgenie.toml. Consider adding goals for better context."
        )
