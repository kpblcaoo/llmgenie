def metrics_status():
    ...
    try:
        from core.llmgenie.metrics_tracker import get_metrics_tracker
...
def metrics_track(event_type, details=None):
    ...
    try:
        from core.llmgenie.metrics_tracker import track_workflow_event
...
def metrics_tokens():
    ...
    try:
        from core.llmgenie.metrics_tracker import get_token_summary, get_metrics_tracker
